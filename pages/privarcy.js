    ...
    return (
        <div>
            <div className='container py-24 mx-auto'>
                <h2 className='text-gray-600 font-bold title-font tracking-wider text-5xl text-center mb-4'>Privacy Policy</h2>
                <div className='mx-6 md:mx-12 break-words px-28'>
                    ...
                    <br />
                    <h1 className='my-2 font-semibold text-4xl'>Interpretation and Definitions</h1>
                    <br />
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                ...
                                {/* (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to RicherLand, Ahmednagar, Maharashtra.   REMAIN TO WRITE HERE */}
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                <strong>Website</strong> refers to RicerLand, accessible from https://www.richerland.com
                            </p>
                        </li>
                        <li>
                            <p>
                    ...
                    <br />
                    <h1 className='my-2 font-semibold text-4xl'>Collecting and Using Your Personal Data</h1>
                    <br />
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>For business transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company ass ets, financing, or acquisition of all or a portion of Our business to another company.
                        </li>
                        <li>
                    ...
                    <br />
                    <h2 className='my-2 font-semibold text-2xl'>Disclosure of Your Personal Data</h2>
                    <br />
                    ...
                    <br />
                    <h2 className='my-2 font-semibold text-2xl'>Childrens Privacy</h2>
                    <p>
                    ...
                    <ul>
                        <li>By visiting this page on our website: <a rel="external nofollow noopener noreferrer" target="_blank" href="https://www.richerland.com/contact">https://www.richerland.com/contact</a></li>
