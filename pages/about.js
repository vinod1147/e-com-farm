    ...
    return (
        <div>
            <div className='container mx-auto flex px-5 py-24 items-center justify-center flex-col'>
                <img className='w-24 md:w-36 mb-10 object-cover object-center rounded' src="/logo.png" alt="Company Logo" />
                <div className='text-center lg:w-2/3 w-full'>
                    ...
                    <div className='flex justify-center'>
                        <button className='inline-flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded text-lg'>Start Shopping</button>
                    </div>
                </div>
            </div>
        </div>
