      ...
      <div>
        <div className='text-gray-600 body-font py-10'>
          <div className='py-2 mx-auto'>
            <h1 className='text-gray-600 font-bold title-font tracking-wider text-3xl text-center mx-4 my-6'>Refund and Cancellation Policy</h1>
            <div className='mx-4 md:mx-24'>
              <p>
                At CodesWear.com, our focus is complete customer satisfaction. In the event, if you are displeased with the services provided , we will refund back the money, provided the reasons are genuine and proved after investigation. Please read the fine prints of each deal before buying it, it provides all the details about the services or the product you purchase.
                <br />
                <br />
              ...
              <p>
                ...
                <br />
                <br />
                If paid by credit card, refunds will be issued to the original credit card provided at the time of purchase and in case of online payment, payments refund will be made to the same account.
              </p>
            </div>
          </div>
        </div>
